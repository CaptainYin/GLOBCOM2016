...
resultsfolder='D:\IEEE_JLT_VONE_2013\IEEE_JLT_VONE_2013\T_VNE_EONs_2013_8_16\results\dt';
files = dir(reqfolder);
request_set_num = 0;
reqfilename = {};
...
for test_name_request_folder_id = 1:request_set_num
    ...
    save([resultsfolder,'\',all_metrics.method,num2str(req),num2str(requests_set.erlangs),'-',str,'.mat'],'all_metrics');
        end
        ...
        %----------------------------------------------------------
        [solution,subNet] = la_lec_dsp_vone(requests,subNet);
        all_metrics.method = 'la_lec_dsp_vone';
        %----------------------------------------------------------
