...
reqfolder='C:\Users\“Û∫Œ«‰\Documents\MATLAB\IEEE_JLT_VONE_2013\IEEE_JLT_VONE_2013\T_VNE_EONs_2013_8_16\requests\dt';
...
for test_name_request_folder_id = 1:request_set_num
    ...
    if ~(requests_set.erlangs == 50 || requests_set.erlangs == 1500 || requests_set.erlangs == 205)
        continue;
    end
    % start testing
    ...
    all_metrics.time_execution = time_ex;
         ...
         save([num2str(req),all_metrics.method,num2str(requests_set.erlangs),'-',str,'.mat'],'all_metrics');
            toc;
        end
