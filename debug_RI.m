...
for test_name_request_folder_id = 1:request_set_num
   subNet=  subNet_save ;
    ...
    all_metrics.time_execution = time_ex;
        ...
        if(req==153)
            disp(req);
         [solution1,subNet1] = la_lec_dsp_RI_vonedebug(requests,subNet);%0:node_mapping failed -1:link_mapping failed -2:controllerbuilding failed
        [solution2,subNet2] = la_lec_dsp_vonedebug(requests,subNet);
        ...
        [solution,subNet]=debug(solution1,subNet1,solution2,subNet2,req);
